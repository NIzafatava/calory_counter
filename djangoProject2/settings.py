...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KET",
    "django-insecure-de44%716oba_)md$1%)qmp&_&wq%b#8n(z@13pj%&(!mi2m7lb",
)
...
INSTALLED_APPS = [
    ...
    "calory_counter.apps.CaloryCounterConfig",
    "django_filters",
    "user",
...
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True
EMAIL_HOST_USER = "izofatova.anastasia@yandex.ru"
EMAIL_HOST_PASSWORD = "dbmkrisobtmyaxdf"
