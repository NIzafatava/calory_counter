...
class SelectFoodForm(forms.ModelForm):
    class Meta:
        ...
        labels = {"food_selected": "Food", "quantity": "Qnty", "meat_type": "Type"}
    ...
    def __init__(self, user, *args, **kwargs):
        ...
        self.fields["food_selected"].widget.attrs[
            "style"
        ] = "width:200px; height:20px;border-color: black;"
        self.fields["quantity"].widget.attrs[
            "style"
        ] = "width:200px; height:20px; background: white;border-color: black;"
        self.fields["meat_type"].widget.attrs[
            "style"
        ] = "width:200px; height:20px;border-color: black;"
...
class SelectExerciseForm(forms.ModelForm):
    ...
    def __init__(self, user, *args, **kwargs):
        ...
        # self.fields['food_selected'].queryset = Food.objects.filter(person_of=user)
        self.fields["exercises_selected"].queryset = Exercise.objects.all().order_by(
            "name"
        )
        self.fields["exercises_selected"].widget.attrs[
            "style"
        ] = "width:200px; height:20px; background: white;border-color: black;"
        self.fields["time_hour_exercise"].widget.attrs[
            "style"
        ] = "width:200px; height:20px;border-color: black;"
