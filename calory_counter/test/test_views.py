...
class RecipesViewTestGet(TestCase):
    ...
    # def test_add_recipe_post(self):
        # self.recipe = Receipe.objects.create(name='recipe1')
        # response = self.client.post(self.detail_recipe_url, {'id': 1, 'name': 'recipe1', 'content':'content'})
        #
        # self.assertIn(self.recipe.name, 'recipe1')