...
from calory_counter.api.views import (FoodListCreateApiView, RecipeListCreateApiView, ExerciseListCreateApiView,
                                      FoodDeleteUpdateApiView, ExerciseDeleteUpdateApiView, RecipeDeleteUpdateApiView,
                                      ProfileViewSet)
...
urlpatterns = [
    ...
    path('api/v1/exerciselist/<int:exercise_id>/', ExerciseDeleteUpdateApiView.as_view()),
